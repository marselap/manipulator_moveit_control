#include <manipulator_moveit_control/JointPositionControl.h>
...
{
	dr_srv = new dynamic_reconfigure::Server<manipulator_moveit_control::JointCtlParamsConfig>(n);
...
void JointControl::configCallback(manipulator_moveit_control::JointCtlParamsConfig &config, uint32_t level)
{
